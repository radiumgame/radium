...
public class Camera extends Component {
     ...
     */
    public Camera() {
        icon = new Texture("EngineAssets/Editor/Icons/camera.png", true).GetTextureID();
    ...
    public void OnAdd() {
        gizmo = new ComponentGizmo(gameObject, new Texture("EngineAssets/Editor/Icons/camera.png", true));
